...
$db = new Database();
$historialPedidosReservas = $db->query("SELECT * FROM historial_pedidos_reservas");
?>
<!DOCTYPE html>
<html lang="en">
                    ...
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            <table id="datatablesSimple">
                                ...
                                <tbody>
                                    <?php
                                    foreach ($historialPedidosReservas as $historialPedidoReserva) {
                                        echo "<tr>";
                                        echo "<td>" . $historialPedidoReserva["id_historial"] . "</td>";
                                        echo "<td>" . $historialPedidoReserva["id_cliente"] . "</td>";
                                        echo "<td>" . $historialPedidoReserva["id_pedido"] . "</td>";
                                        echo "<td>" . $historialPedidoReserva["id_reserva"] . "</td>";
                                        echo "<td>" . $historialPedidoReserva["fecha_historial"] . "</td>";
                                        echo "<td>" . $historialPedidoReserva["descripcion"] . "</td>";
